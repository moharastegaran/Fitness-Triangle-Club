...
class WorkoutProgramController extends Controller
{
    public function index()
    {
        ...
        //date_diff(Carbon::parse($last['from'])->addDays($last['duration']),Carbon::now())->d
    ...
    private function getDay($index, $switch)
    {
        switch ($index) {
            case 1 :
                return $switch ? "شنبه" : "روز اول";
            case 2 :
                return $switch ? "یکشنبه" : "روز دوم";
            case 3 :
                return $switch ? "دوشنبه" : "روز سوم";
            case 4 :
                return $switch ? "سه‌شنبه" : "روز چهارم";
            case 5 :
                return $switch ? "چهارشنبه" : "روز پنجم";
            case 6 :
                return $switch ? "پنج‌شنبه" : "روز ششم";
            case 7 :
                return $switch ? "جمعه" : "روز هفتم";
            default :
                return "";
        }
    }
