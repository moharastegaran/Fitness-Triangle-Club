...
//        if($category_id) {
//            $workouts = $workouts->where('category_id', $category_id);
//        }
//        if($q) {
//            $workouts = $workouts->where('title', 'like', "%$q%");
//        }

//        $workouts = $workouts->latest()->get();
        return view('panel.workouts.index')->with(compact('workouts', 'categories'));
    }
