...
<head>
    <meta charset="utf-8">
    <title>Fitness Triangle Club</title>
    <!-- Stylesheets -->
...
<div class="page-wrapper">
    ...
    <header class="main-header header-style-one">
        ...
        <div class="header-upper">
            <div class="outer-container">
                <div class="inner-container clearfix">
                    ...
                    <!-- Logo Box -->
                    <div class="logo-box">
                        <div class="logo"><a href="index.html"><img src="{{ asset('blackfit/images/logo.svg') }}" alt="" title=""></a></div>
                    </div>

                    <!-- Logo -->
                    <div class="mobile-logo pull-left">
                        <a href="index.html" title=""><img src="{{ asset('blackfit/images/logo-small.svg') }}" alt="" title=""></a>
                    </div>
                    ...
                    <div class="outer-box clearfix">
                        ...
                        <div class="nav-toggler">
                            <div class="nav-btn"><button class="hidden-bar-opener"><span class="icon"><img src="{{ asset('blackfit/images/icons/burger.svg') }}" alt=""></span></button></div>
                        </div>
                        <!-- / Hidden Nav Toggler -->
                    ...
                    <div class="nav-outer clearfix">
                        ...
                        <div class="mobile-nav-toggler"><span class="icon"><img src="{{ asset('blackfit/images/icons/burger.svg') }}" alt=""></span></div>
                        <!-- Main Menu -->
        ...
        <div class="mobile-menu">
            ...
            <nav class="menu-box">
                <div class="nav-logo"><a href="index.html"><img src="{{ asset('blackfit/images/sidebar-logo.svg') }}" alt="" title=""></a></div>
                        ...
                        <div class="row clearfix">
                            ...
                            <div class="footer-column col-lg-6 col-md-6 col-sm-12">
                                <div class="footer-widget logo-widget">
                                    <div class="logo">
                                        <a href="index.html"><img src="{{ asset('blackfit/images/footer-logo.svg') }}" alt=""></a>
                                    </div>
                                    <!-- Footer Mobile Logo -->
                                    <div class="footer-mobile-logo">
                                        <a href="index.html"><img src="{{ asset('blackfit/images/logo.svg') }}" alt="" title=""></a>
                                    </div>
                                    <ul class="info-list">
                                    ...
                                    <div class="newsletter-form">
                                        <form method="post" action="contact.html">
                                            <div class="form-group">
                                                ...
                                                <button type="submit" class="theme-btn submit-btn"><span><img src="{{ asset('blackfit/images/icons/message-icon.png') }}" alt=""></span></button>
                                            </div>
                                        </form>
                                    </div>
