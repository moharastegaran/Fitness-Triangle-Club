...
@section('content')
    <form role="form" class="col-12" action="{{ route('panel.admin.nutrition-programs.update',$program) }}"
          method="post">
                ...
                <select name="requester_name" class="form-control form-control-sm" id="requester_name">
                    ...
                    @foreach($members as $member)
                        <option value="{{ $member->name.' '.$member->family }}"
                                @if(old('requester_name')==$member->name.' '.$member->family) selected
                                @elseif(!old('requester_name') && $program->requester_name==$member->name.' '.$member->family) selected @endif>
        ...
        <div>
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="d-flex">
                    <label class="switch s-icons s-outline s-outline-warning mr-1">
                        <input name="day_type" type="hidden">
                        <input id="day_type_switch" type="checkbox" @if($program->day_type) checked @endif>
            ...
            @php $day_type=($program->day_type)? true : false @endphp
            <div class="tab-content">
                <div class="tab-pane fade show active" id="tab_1" role="tabpanel" aria-labelledby="justify-tab-1">
                    <table class="table table-bordered">
                        ...
                        <tbody>
                        @include('panel.nutrition_programs.rows',['index'=>1,'day' => ($day_type ? 'شنبه' : 'روز اول')])
                        </tbody>
                    </table>
                </div>
                <div class="tab-pane fade" id="tab_2" role="tabpanel" aria-labelledby="justify-tab-2">
                    <table class="table table-bordered">
                        ...
                        <tbody>
                        @include('panel.nutrition_programs.rows',['index'=>2,'day' => ($day_type ? 'یک‌شنبه' : 'روز دوم')])
                        </tbody>
                    </table>
                </div>
                <div class="tab-pane fade" id="tab_3" role="tabpanel" aria-labelledby="justify-tab-3">
                    <table class="table table-bordered">
                        ...
                        <tbody>
                        @include('panel.nutrition_programs.rows',['index'=>3,'day' => ($day_type ? 'دو‌شنبه' : 'روز سوم')])
                        </tbody>
                    </table>
                </div>
                <div class="tab-pane fade" id="tab_4" role="tabpanel" aria-labelledby="justify-tab-4">
                    <table class="table table-bordered">
                        ...
                        <tbody>
                        @include('panel.nutrition_programs.rows',['index'=>4,'day' => ($day_type ? 'سه‌شنبه' : 'روز چهارم')])
                        </tbody>
                    </table>
                </div>
                <div class="tab-pane fade" id="tab_5" role="tabpanel" aria-labelledby="justify-tab-5">
                    <table class="table table-bordered">
                        ...
                        <tbody>
                        @include('panel.nutrition_programs.rows',['index'=>5,'day' => ($day_type ? 'چهار‌شنبه' : 'روز پنجم')])
                        </tbody>
                    </table>
                </div>
                <div class="tab-pane fade" id="tab_6" role="tabpanel" aria-labelledby="justify-tab-6">
                    <table class="table table-bordered">
                        ...
                        <tbody>
                        @include('panel.nutrition_programs.rows',['index'=>6,'day' => ($day_type ? 'پنج‌شنبه' : 'روز ششم')])
                        </tbody>
                    </table>
                </div>
                <div class="tab-pane fade" id="tab_7" role="tabpanel" aria-labelledby="justify-tab-7">
                    <table class="table table-bordered">
                        ...
                        <tbody>
                        @include('panel.nutrition_programs.rows',['index'=>7,'day' => ($day_type ? 'جمعه' : 'روز هفتم')])
                        </tbody>
                    </table>
                </div>
            </div>
...
`);
        ...
        $(document).ready(function () {
            ...
            var switched = {{$program->day_type}};
            switched = (switched==0) ? false : true;
            ...
            $("#day_type_switch").siblings("input[name='day_type']").val(switched);
