...
@section('content-header')
    <div class="w-100 d-flex flex-wrap justify-content-md-end justify-content-center">
        <a type="button" href="{{ route('panel.admin.nutrition-programs.create') }}"
           class="btn btn-lg text-white mb-1 border-0"
           style="background:none;background-image: linear-gradient(to left, #5c1ac3 0%, transparent 100%);margin-left: 7px">برنامه
            غذایی جدید
        ...
        <a type="button" href="{{ route('panel.admin.nutritions.create') }}" class="btn btn-lg text-white mb-1 border-0"
           style="background:none;background-image: linear-gradient(to right, #5c1ac3 0%, transparent 100%);margin-left: 7px">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                 stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                 class="feather feather-list mr-1">
        ...
        <tr>
            ...
            <td>
                <ul class="table-controls">
                    <li><a href="{{ route('panel.nutrition-programs.export-pdf',$nutritionProgram) }}"
                           target="_blank">
                    ...
                    <li><a href="{{ route('panel.nutrition-programs.show', $nutritionProgram) }}"
                           class="bs-tooltip"
