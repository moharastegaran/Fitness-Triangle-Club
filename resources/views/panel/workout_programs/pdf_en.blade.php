    ...
    <div class="col-12 layout-spacing">
        <div class="statbox widget box box-shadow">
            <div class="widget-header">
                <div class="col-12">
                    <h3 class="direct-h3">مشخصات</h3>
                </div>
            </div>
            <div class="widget-content-area">
                <div class="width-100">
                    <div class="head-parent">
                        <span class="head-key">نام ورزشکار :</span>
                        <strong class="head-value">{{ $program->getRequesterName() }}</strong>
                    </div>
                    <div class="head-parent">
                        <span class="head-key">‌تاریخ شروع :</span>
                        <strong class="head-value">{{ \Morilog\Jalali\Jalalian::forge($program->from)->format('%d %B %y') }}</strong>
                    </div>
                    <div class="head-parent">
                        <span class="head-key">مدت زمان :</span>
                        <strong class="head-value">{{ ($program->duration).' روز' }}</strong>
                    </div>
                    <div class="head-parent">
                        <span class="head-key">توضیحات :</span>
                    ...
                    <div style="width: 100%" class="table-responsive">
                        <table style="width: 100%" class="table table-bordered mb-4">
                            ...
                            <tr style="margin: 0;padding: 0">
                                <th class="table-head">تمرین</th>
                                <th class="table-head">ست</th>
                                <th class="table-head">تکرار</th>
                                <th class="table-head">ریتم</th>
                                <th class="table-head">استراحت<span style="font-size: 10px">(ثانیه)</span></th>
                                <th class="table-head">توضیحات</th>
                                {{--<th></th>--}}
                            </tr>
                            </thead>
                            <tbody>
