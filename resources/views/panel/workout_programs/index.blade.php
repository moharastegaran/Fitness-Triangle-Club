...
@section('breadcrumb')
    <li class="breadcrumb-item active"><a href="{{ route('panel.admin.workout-programs.index') }}">برنامه‌های تمرینی</a></li>
@endsection


@section('content-header')
    <div class="w-100 d-flex justify-content-md-end justify-content-center">
        <a type="button" href="{{ route('panel.admin.workout-programs.create') }}" class="btn btn-lg text-white border-0 mb-1" style="background:none;background-image: linear-gradient(to left, #5c1ac3 0%, transparent 100%);margin-left: 7px"> برنامه تمرینی جدید
