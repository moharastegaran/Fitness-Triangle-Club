                ...
                <select name="requester_name" class="form-control form-control-sm" id="requester_name">
                    ...
                    @foreach($members as $member)
                        <option value="{{ $member->id.'%%'.$member->name.' '.$member->family }}"
                                @if(old('requester_name')==$member->id.'%%'.$member->name.' '.$member->family) selected
                                @elseif(!old('requester_name') && $program->requester_name==$member->name.' '.$member->family) selected
            ...
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="d-flex">
                    <label class="switch s-icons s-outline s-outline-warning mr-1">
                        <input name="day_type" type="hidden" value="@if($program->day_type) 1 @else 0 @endif">
                ...
                <div class="tab-pane fade show active" id="tab_1" role="tabpanel" aria-labelledby="justify-tab-1">
                    <div class="box-body pad table-responsive">
                        <table class="table table-bordered" style="table-layout: fixed">
                            ...
                            <tbody>
                            @include('panel.workout_programs.rows',['index'=>1,'day' => ($day_type ? 'شنبه' : 'روز اول')])
                            </tbody>
                        </table>
                    </div>
                </div>
                <div class="tab-pane fade" id="tab_2" role="tabpanel" aria-labelledby="justify-profile-tab">
                    <div class="box-body pad table-responsive">
                        <table class="table table-bordered" style="table-layout: fixed">
                            ...
                            <tbody>
                            @include('panel.workout_programs.rows',['index'=>2,'day' => ($day_type ? 'یک‌شنبه' : 'روز دوم')])
                            </tbody>
                        </table>
                    </div>
                </div>
                <div class="tab-pane fade" id="tab_3" role="tabpanel" aria-labelledby="justify-contact-tab">
                    <div class="box-body pad table-responsive">
                        <table class="table table-bordered" style="table-layout: fixed">
                            ...
                            <tbody>
                            @include('panel.workout_programs.rows',['index'=>3,'day' => ($day_type ? 'دو‌شنبه' : 'روز سوم')])
                            </tbody>
                        </table>
                    </div>
                </div>
                <div class="tab-pane fade" id="tab_4" role="tabpanel" aria-labelledby="justify-contact-tab">
                    <div class="box-body pad table-responsive">
                        <table class="table table-bordered" style="table-layout: fixed">
                            ...
                            <tbody>
                            @include('panel.workout_programs.rows',['index'=>4,'day' => ($day_type ? 'سه‌شنبه' : 'روز چهارم')])
                            </tbody>
                        </table>
                    </div>
                </div>
                <div class="tab-pane fade" id="tab_5" role="tabpanel" aria-labelledby="justify-contact-tab">
                    <div class="box-body pad table-responsive">
                        <table class="table table-bordered" style="table-layout: fixed">
                            ...
                            <tbody>
                            @include('panel.workout_programs.rows',['index'=>5,'day' => ($day_type ? 'چهار‌شنبه' : 'روز پنجم')])
                            </tbody>
                        </table>
                    </div>
                </div>
