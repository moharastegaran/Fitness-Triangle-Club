...
{% for (var i=0, file; file=o.files[i]; i++) { %}
 <div class="template-download statbox widget box box-shadow rounded mt-2 mb-1">
  ...
  <div class="col-lg-3 col-md-4 col-sm-6 col-12 text-md-left text-center">
  ...
  {% } %}
     ...
     <div class="date col-lg-3 col-md-4 col-sm-6 col-12 text-md-left text-center">
  <span class="text-muted" dir="rtl">{%=file.created_at%}</span>
  </div>


    <div class="col-lg-2 col-md-4 col-sm-4 col-12 text-md-left text-center text-light" dir="rtl">
...
{{--<div class="col-md-1"></div>--}}
    ...
    <div class="col-md-2 col-sm-2 col-12 text-center d-flex flex-wrap flex-md-row flex-sm-column-reverse flex-row justify-content-center align-items-center">
{% if (file.deleteUrl) { %}
