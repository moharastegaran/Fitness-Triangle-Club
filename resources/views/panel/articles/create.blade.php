...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active" aria-current="page"><span>مقاله جدید</span></li>
@endsection
    ...
    <div class="col-md-9 col-12 mx-auto">
        <div class="statbox widget box box-shadow">
            <div class="widget-content widget-content-area">
                <form method="post" action="{{ route('panel.admin.articles.store') }}" enctype="multipart/form-data"
                      class="row mx-auto">
                    ...
                    <div class="col-sm-6 col-12 my-1">
                        ...
                        <input type="text" name="title" class="form-control" id="title" autocomplete="off"
                               placeholder="روش های تغذیه سالم" value="{{ old('title') }}">
                    </div>
                    <div class="col-sm-6 col-12 my-1">
                        <label for="category">دسته بندی</label>
                        <input type="text" name="category" class="form-control" id="category" autocomplete="off"
                               placeholder="تغذیه‌ای" value="{{ old('category') }}">
                    </div>
                    ...
                    <div class="col-12">
                        ...
                        <textarea id="context" name="content">{!! old('content') !!}</textarea>
                    </div>
