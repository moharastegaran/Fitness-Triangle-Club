...
@section('content')
    ...
    <div class="col-md-9 col-12 mx-auto">
        ...
        <form id="fileupload" method="post" action="{{ route('panel.admin.workouts.store') }}"
  ...
  <source src="{{ asset($path.'0/'.$file->filename) }}">
       ...
       @endif
            ...
            <div class="col-12 text-right">
                    {{--<input type="hidden" name="_redirect" value="0">--}}
                    <input id="btn-submit" type="submit" class="btn btn-primary px-4" value="ثبت">
                    {{--<input id="btn-submit1" type="button" class="btn btn-primary px-4" value="ثبت و ثبت مجدد">--}}
            </div>
        </form>
    </div>
